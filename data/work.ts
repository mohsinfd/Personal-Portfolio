...
export const WORK_DATA: SelectedWork[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Built a B2B computer-vision scoring engine for eSports titles without reliable structured score data...that later led to the pivot and rebranding to Spectatr.ai"
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Scaled supply to 500+ hotels in india",
