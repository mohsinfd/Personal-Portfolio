...
OPERATING RANGE
API-first fintech platforms | Cards and loans journeys | Recommendation engines and calculators | 0-to-1 vertical launches | KYC/compliance-aware UX | AI-led prototyping and MVP acceleration | Whitelabel product surfaces | Growth, engagement, and retention systems | Cross-functional leadership with strong IC execution

PLATFORM LEADERSHIP YEARS

CashKaro / BankKaro - Associate Director of Product (Product Lead, BankKaro)
June 2024 - Present | India
- Took BankKaro and great.cards from 0-to-1 within ~1 year, owning product strategy, platform design, UX direction, launch readiness, and ongoing iteration.
